...
This project implements a Meta Quest XR application in Unity with a login system, combined project/floor selection, backend API integration, XR-compatible navigation, and a polished world-space user interface. The experience is designed as a compact product flow rather than a generic assignment screen.
