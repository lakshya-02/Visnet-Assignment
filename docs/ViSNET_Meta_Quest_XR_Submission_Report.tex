...
The Unity project uses a single-scene architecture for reliability and speed. The scene contains a Meta Quest-style world-space dashboard, Inspector-wired UI references, button navigation logic, and backend API calls.
...
The application must support testing through Meta XR Simulator and Meta Quest headset builds. Editor validation can be performed with Meta XR Simulator, while final device validation should use a Meta Quest 2, Quest 3, or Quest Pro APK install.
