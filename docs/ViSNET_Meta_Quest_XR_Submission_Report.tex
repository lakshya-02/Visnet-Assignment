...
The interface is designed to feel closer to a Quest-native spatial UI. It uses a compact controller-mounted action menu inspired by the provided Civit/Quest reference, with dark rounded panels, pill-shaped action buttons, floor/project selection rows, high contrast typography, and world-space toast notifications. The UI is readable at VR distance and avoids a flat desktop form layout.
